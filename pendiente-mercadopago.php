                            ...
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                        ...
                                        <h3><?php echo "el monto pendiente de pago es: " .$pagos["transaction_amount"]." ".$pagos["currency_id"];?></h3>
                                        <h3><?php echo "la orden de el pedido pendiente es: " .$orden["id"];?></h3>
                                        <h3><?php echo "La id de el pago pendiente es: " .$pagos["id"];?></h3>
                                        <?php }else{ ?>
